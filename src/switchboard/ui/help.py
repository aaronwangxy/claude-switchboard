...
HELP_TEXT = "\n".join(
    ...
    + [
        ...
        "  Jobs (bottom)        each job, its workflow and step, with its sessions under it.",
        "                       ! needs you   ● working   ✓ complete/idle",
        "  Detail (right)       a job: where its run stands and what is left before it is done.",
        "                       a session: workflow, ownership, worktree, and evidence.",
